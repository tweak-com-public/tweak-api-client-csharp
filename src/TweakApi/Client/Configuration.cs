...
namespace TweakApi.Client
{
    ...
    public class Configuration
    {
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 100000,
                             string userAgent = "Swagger-Codegen/1.0.3-alpha.10/csharp"
                            )
        {
        ...
        public const string Version = "1.0.3-alpha.10";
        ...
        {
            String report = "C# SDK (TweakApi) Debug Report:\n";
            report += "    OS: " + Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + Assembly
                     .GetExecutingAssembly()
                     .GetReferencedAssemblies()
                     .Where(x => x.Name == "System.Core").First().Version.ToString()  + "\n";
            report += "    Version of the API: 1.0.3-alpha.14\n";
            report += "    SDK Package Version: 1.0.3-alpha.10\n";

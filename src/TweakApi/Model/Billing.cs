...
namespace TweakApi.Model
{
    ...
    public partial class Billing :  IEquatable<Billing>
    {
        ...
        /// <param name="CompanyBankAccount">CompanyBankAccount.</param>
        /// <param name="CompanySource">CompanySource.</param>
        ...
        /// <param name="StripeBankAccountId">StripeBankAccountId.</param>
        /// <param name="StripeSourceId">StripeSourceId.</param>
        /// <param name="StripeSubscriptionId">StripeSubscriptionId.</param>
        /// <param name="Id">Id.</param>
        /// <param name="TeamId">TeamId.</param>
        /// <param name="Team">Team.</param>
        public Billing(string CompanyName = null, string CompanyEmail = null, string CompanyVat = null, BillingCard CompanyCard = null, BillingBankAccount CompanyBankAccount = null, BillingSource CompanySource = null, BillingSubscription Subscription = null, BillingLimit Limit = null, double? TaxPercent = null, string StripeCustomerId = null, string StripeCardId = null, string StripeBankAccountId = null, string StripeSourceId = null, string StripeSubscriptionId = null, string Id = null, string TeamId = null, Team Team = null)
        {
        ...
        /// <summary>
        /// Gets or Sets CompanyBankAccount
        /// </summary>
        [DataMember(Name="companyBankAccount", EmitDefaultValue=false)]
        public BillingBankAccount CompanyBankAccount { get; set; }
        /// <summary>
        /// Gets or Sets CompanySource
        /// </summary>
        [DataMember(Name="companySource", EmitDefaultValue=false)]
        public BillingSource CompanySource { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets StripeBankAccountId
        /// </summary>
        [DataMember(Name="stripeBankAccountId", EmitDefaultValue=false)]
        public string StripeBankAccountId { get; set; }
        /// <summary>
        /// Gets or Sets StripeSourceId
        /// </summary>
        [DataMember(Name="stripeSourceId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CompanyBankAccount: ").Append(CompanyBankAccount).Append("\n");
            sb.Append("  CompanySource: ").Append(CompanySource).Append("\n");
            ...
            sb.Append("  StripeBankAccountId: ").Append(StripeBankAccountId).Append("\n");
            sb.Append("  StripeSourceId: ").Append(StripeSourceId).Append("\n");
        ...
        public bool Equals(Billing other)
        {
            ...
            return 
                ...
                (
                    this.CompanyBankAccount == other.CompanyBankAccount ||
                    this.CompanyBankAccount != null &&
                    this.CompanyBankAccount.Equals(other.CompanyBankAccount)
                ) && 
                (
                    this.CompanySource == other.CompanySource ||
                    this.CompanySource != null &&
                    this.CompanySource.Equals(other.CompanySource)
                ) && 
                (
                ...
                (
                    this.StripeBankAccountId == other.StripeBankAccountId ||
                    this.StripeBankAccountId != null &&
                    this.StripeBankAccountId.Equals(other.StripeBankAccountId)
                ) && 
                (
                    this.StripeSourceId == other.StripeSourceId ||
                    this.StripeSourceId != null &&
                    this.StripeSourceId.Equals(other.StripeSourceId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CompanyBankAccount != null)
                    hash = hash * 59 + this.CompanyBankAccount.GetHashCode();
                if (this.CompanySource != null)
                    hash = hash * 59 + this.CompanySource.GetHashCode();
                ...
                if (this.StripeBankAccountId != null)
                    hash = hash * 59 + this.StripeBankAccountId.GetHashCode();
                if (this.StripeSourceId != null)
                    hash = hash * 59 + this.StripeSourceId.GetHashCode();

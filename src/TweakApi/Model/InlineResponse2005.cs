...
namespace TweakApi.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>
    {
        ...
        /// </summary>
        /// <param name="CanIncrease">CanIncrease.</param>
        public InlineResponse2005(bool? CanIncrease = null)
        {
            this.CanIncrease = CanIncrease;
        }
        
        /// <summary>
        /// Gets or Sets CanIncrease
        /// </summary>
        [DataMember(Name="canIncrease", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CanIncrease: ").Append(CanIncrease).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2005 other)
        {
            ...
            return 
                (
                    this.CanIncrease == other.CanIncrease ||
                    this.CanIncrease != null &&
                    this.CanIncrease.Equals(other.CanIncrease)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CanIncrease != null)
                    hash = hash * 59 + this.CanIncrease.GetHashCode();
                return hash;
            }
        }
    }

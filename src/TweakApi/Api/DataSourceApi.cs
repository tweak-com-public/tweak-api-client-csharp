...
namespace TweakApi.Api
{
    ...
    public interface IDataSourceApi : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2001> DataSourcesIdKeysCountGetWithHttpInfo (string id, string where = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<InlineResponse2001> DataSourcesIdKeysCountGetAsync (string id, string where = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2001>> DataSourcesIdKeysCountGetAsyncWithHttpInfo (string id, string where = null);
        /// <summary>
        /// Deletes all keys of this model.
        /// </summary>
        /// <remarks>
    ...
    public partial class DataSourceApi : IDataSourceApi
    {
        ...
        /// <param name="where">Criteria to match model instances (optional)</param>
        /// <returns>InlineResponse2001</returns>
        public InlineResponse2001 DataSourcesIdKeysCountGet (string id, string where = null)
        {
             ApiResponse<InlineResponse2001> localVarResponse = DataSourcesIdKeysCountGetWithHttpInfo(id, where);
        ...
        /// <param name="where">Criteria to match model instances (optional)</param>
        /// <returns>ApiResponse of InlineResponse2001</returns>
        public ApiResponse< InlineResponse2001 > DataSourcesIdKeysCountGetWithHttpInfo (string id, string where = null)
        {
        ...
        /// <param name="where">Criteria to match model instances (optional)</param>
        /// <returns>Task of InlineResponse2001</returns>
        public async System.Threading.Tasks.Task<InlineResponse2001> DataSourcesIdKeysCountGetAsync (string id, string where = null)
        {
             ApiResponse<InlineResponse2001> localVarResponse = await DataSourcesIdKeysCountGetAsyncWithHttpInfo(id, where);
             return localVarResponse.Data;
        ...
        /// <param name="where">Criteria to match model instances (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2001)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2001>> DataSourcesIdKeysCountGetAsyncWithHttpInfo (string id, string where = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DataSourceApi->DataSourcesIdKeysCountGet");

...
namespace Example
{
    public class PortalTemplatesCountGetExample
    {
        public void main()
        {
            ...
            {
                // Count instances of the model matched by where from the data source.
                InlineResponse200 result = apiInstance.PortalTemplatesCountGet(where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PortalTemplatesIdExistsGetExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.PortalTemplatesIdExistsGet(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PortalTemplatesIdHeadExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.PortalTemplatesIdHead(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PortalTemplatesUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2002 result = apiInstance.PortalTemplatesUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {

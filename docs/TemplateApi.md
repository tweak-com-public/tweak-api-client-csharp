...
namespace Example
{
    public class TemplatesPatchExample
    {
        public void main()
        {
            ...
            {
                // Patch an existing model instance or insert a new one into the data source.
                Template result = apiInstance.TemplatesPatch(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling TemplateApi.TemplatesPatch: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class TemplatesPutExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                Template result = apiInstance.TemplatesPut(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling TemplateApi.TemplatesPut: " + e.Message );
            }
        }
    }
}
...
<a name="templatesreplaceorcreatepost"></a>
...
namespace Example
{
    public class TemplatesReplaceOrCreatePostExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                Template result = apiInstance.TemplatesReplaceOrCreatePost(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling TemplateApi.TemplatesReplaceOrCreatePost: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class TemplatesUpdatePostExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TemplateApi.TemplatesUpdatePost: " + e.Message );
            }
        }
    }
}
...
<a name="templatesupsertwithwherepost"></a>
...
namespace Example
{
    public class TemplatesUpsertWithWherePostExample
    {
        public void main()
        {
            ...
            {
                // Update an existing model instance or insert a new one into the data source based on the where criteria.
                Template result = apiInstance.TemplatesUpsertWithWherePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling TemplateApi.TemplatesUpsertWithWherePost: " + e.Message );
            }
        }
    }
}

...
> InlineResponse2001 PortalImageFoldersCountGet (string where = null)
...
namespace Example
{
    public class PortalImageFoldersCountGetExample
    {
        public void main()
        {
            ...
            {
                // Count instances of the model matched by where from the data source.
                InlineResponse2001 result = apiInstance.PortalImageFoldersCountGet(where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2003 PortalImageFoldersUpdatePost (string where = null, PortalImageFolder data = null)
...
namespace Example
{
    public class PortalImageFoldersUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2003 result = apiInstance.PortalImageFoldersUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {

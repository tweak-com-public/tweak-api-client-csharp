...
> InlineResponse200 PortalPermissionSetsCountGet (string where = null)
...
namespace Example
{
    public class PortalPermissionSetsCountGetExample
    {
        public void main()
        {
            ...
            {
                // Count instances of the model matched by where from the data source.
                InlineResponse200 result = apiInstance.PortalPermissionSetsCountGet(where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2001 PortalPermissionSetsIdExistsGet (string id)
...
namespace Example
{
    public class PortalPermissionSetsIdExistsGetExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.PortalPermissionSetsIdExistsGet(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2001 PortalPermissionSetsIdHead (string id)
...
namespace Example
{
    public class PortalPermissionSetsIdHeadExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.PortalPermissionSetsIdHead(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
<a name="portalpermissionsetspatch"></a>
...
namespace Example
{
    public class PortalPermissionSetsPatchExample
    {
        public void main()
        {
            ...
            {
                // Patch an existing model instance or insert a new one into the data source.
                PortalPermissionSet result = apiInstance.PortalPermissionSetsPatch(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PortalPermissionSetApi.PortalPermissionSetsPatch: " + e.Message );
            }
        }
    }
}
...
<a name="portalpermissionsetsput"></a>
...
namespace Example
{
    public class PortalPermissionSetsPutExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                PortalPermissionSet result = apiInstance.PortalPermissionSetsPut(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PortalPermissionSetApi.PortalPermissionSetsPut: " + e.Message );
            }
        }
    }
}
...
<a name="portalpermissionsetsreplaceorcreatepost"></a>
...
namespace Example
{
    public class PortalPermissionSetsReplaceOrCreatePostExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                PortalPermissionSet result = apiInstance.PortalPermissionSetsReplaceOrCreatePost(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PortalPermissionSetApi.PortalPermissionSetsReplaceOrCreatePost: " + e.Message );
            }
        }
    }
}
...
<a name="portalpermissionsetsupdatepost"></a>
# **PortalPermissionSetsUpdatePost**
> InlineResponse2002 PortalPermissionSetsUpdatePost (string where = null, PortalPermissionSet data = null)
...
namespace Example
{
    public class PortalPermissionSetsUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2002 result = apiInstance.PortalPermissionSetsUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PortalPermissionSetApi.PortalPermissionSetsUpdatePost: " + e.Message );
            }
        }
    }
}
...
<a name="portalpermissionsetsupsertwithwherepost"></a>
...
namespace Example
{
    public class PortalPermissionSetsUpsertWithWherePostExample
    {
        public void main()
        {
            ...
            {
                // Update an existing model instance or insert a new one into the data source based on the where criteria.
                PortalPermissionSet result = apiInstance.PortalPermissionSetsUpsertWithWherePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PortalPermissionSetApi.PortalPermissionSetsUpsertWithWherePost: " + e.Message );
            }
        }
    }
}

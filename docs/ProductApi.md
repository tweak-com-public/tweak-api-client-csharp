...
namespace Example
{
    public class ProductsCountGetExample
    {
        public void main()
        {
            ...
            {
                // Count instances of the model matched by where from the data source.
                InlineResponse200 result = apiInstance.ProductsCountGet(where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ProductsIdExistsGetExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.ProductsIdExistsGet(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ProductsIdHeadExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2001 result = apiInstance.ProductsIdHead(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ProductsIdTagsCountGetExample
    {
        public void main()
        {
            ...
            {
                // Counts tags of Product.
                InlineResponse200 result = apiInstance.ProductsIdTagsCountGet(id, where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ProductsIdTagsDeleteExample
    {
        public void main()
        {
            ...
            {
                // Deletes all tags of this model.
                apiInstance.ProductsIdTagsDelete(id);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsIdTagsDelete: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ProductsPatchExample
    {
        public void main()
        {
            ...
            {
                // Patch an existing model instance or insert a new one into the data source.
                Product result = apiInstance.ProductsPatch(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsPatch: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ProductsPutExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                Product result = apiInstance.ProductsPut(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsPut: " + e.Message );
            }
        }
    }
}
...
<a name="productsreplaceorcreatepost"></a>
...
namespace Example
{
    public class ProductsReplaceOrCreatePostExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                Product result = apiInstance.ProductsReplaceOrCreatePost(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsReplaceOrCreatePost: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ProductsUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2002 result = apiInstance.ProductsUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsUpdatePost: " + e.Message );
            }
        }
    }
}
...
<a name="productsupsertwithwherepost"></a>
...
namespace Example
{
    public class ProductsUpsertWithWherePostExample
    {
        public void main()
        {
            ...
            {
                // Update an existing model instance or insert a new one into the data source based on the where criteria.
                Product result = apiInstance.ProductsUpsertWithWherePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductApi.ProductsUpsertWithWherePost: " + e.Message );
            }
        }
    }
}

...
namespace Example
{
    public class DataSourceSoapsPatchExample
    {
        public void main()
        {
            ...
            {
                // Patch an existing model instance or insert a new one into the data source.
                DataSourceSoap result = apiInstance.DataSourceSoapsPatch(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling DataSourceSoapApi.DataSourceSoapsPatch: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class DataSourceSoapsPutExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                DataSourceSoap result = apiInstance.DataSourceSoapsPut(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling DataSourceSoapApi.DataSourceSoapsPut: " + e.Message );
            }
        }
    }
}
...
<a name="datasourcesoapsreplaceorcreatepost"></a>
...
namespace Example
{
    public class DataSourceSoapsReplaceOrCreatePostExample
    {
        public void main()
        {
            ...
            {
                // Replace an existing model instance or insert a new one into the data source.
                DataSourceSoap result = apiInstance.DataSourceSoapsReplaceOrCreatePost(data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling DataSourceSoapApi.DataSourceSoapsReplaceOrCreatePost: " + e.Message );
            }
        }
    }
}
...
<a name="datasourcesoapsupdatepost"></a>
...
namespace Example
{
    public class DataSourceSoapsUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2003 result = apiInstance.DataSourceSoapsUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling DataSourceSoapApi.DataSourceSoapsUpdatePost: " + e.Message );
            }
        }
    }
}
...
<a name="datasourcesoapsupsertwithwherepost"></a>
...
namespace Example
{
    public class DataSourceSoapsUpsertWithWherePostExample
    {
        public void main()
        {
            ...
            {
                // Update an existing model instance or insert a new one into the data source based on the where criteria.
                DataSourceSoap result = apiInstance.DataSourceSoapsUpsertWithWherePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling DataSourceSoapApi.DataSourceSoapsUpsertWithWherePost: " + e.Message );
            }
        }
    }
}

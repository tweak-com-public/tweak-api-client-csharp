...
> InlineResponse2001 TeamBuilderConfigProductSizesCountGet (string where = null)
...
namespace Example
{
    public class TeamBuilderConfigProductSizesCountGetExample
    {
        public void main()
        {
            ...
            {
                // Count instances of the model matched by where from the data source.
                InlineResponse2001 result = apiInstance.TeamBuilderConfigProductSizesCountGet(where);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2002 TeamBuilderConfigProductSizesIdExistsGet (string id)
...
namespace Example
{
    public class TeamBuilderConfigProductSizesIdExistsGetExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2002 result = apiInstance.TeamBuilderConfigProductSizesIdExistsGet(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2002 TeamBuilderConfigProductSizesIdHead (string id)
...
namespace Example
{
    public class TeamBuilderConfigProductSizesIdHeadExample
    {
        public void main()
        {
            ...
            {
                // Check whether a model instance exists in the data source.
                InlineResponse2002 result = apiInstance.TeamBuilderConfigProductSizesIdHead(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> InlineResponse2003 TeamBuilderConfigProductSizesUpdatePost (string where = null, TeamBuilderConfigProductSize data = null)
...
namespace Example
{
    public class TeamBuilderConfigProductSizesUpdatePostExample
    {
        public void main()
        {
            ...
            {
                // Update instances of the model matched by {{where}} from the data source.
                InlineResponse2003 result = apiInstance.TeamBuilderConfigProductSizesUpdatePost(where, data);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
